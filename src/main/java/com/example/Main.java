...
public class Main {
    ...
    private static Contact readContact(int contactType) {
        ...
        if (contactType == 1) {
            ...
            System.out.print("Enter organization phone number: ");
            String organizationPhoneNumber = scanner.nextLine();
            System.out.print("Enter organization email: ");
            String organizationEmail = scanner.nextLine();
            Organization organization = new Organization(organizationName, organizationPhoneNumber, organizationEmail);
